-- Fix start_spider_skirmish to use Pacific time day bounds instead of UTC
...
BEGIN
  ...
  -- Day bounds in Pacific time (consistent with weekly boundaries)
...
-- Fix get_spider_skirmish_suggestion to use Pacific time day bounds
