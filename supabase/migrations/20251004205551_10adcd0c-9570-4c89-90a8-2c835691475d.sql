-- Update the handle_new_user function to register the starter spider in weekly_uploads
...
BEGIN
  ...
  -- Register the starter spider in weekly_uploads so it shows as eligible
